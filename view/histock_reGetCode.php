...
//
////取得HT競賽資訊
//$sqlHT = mysql_query(" SELECT * FROM histock_eventList WHERE projectNO LIKE 'HT%' ORDER BY id DESC ");
//$sqlHTFetch = mysql_fetch_row($sqlHT);
//$HTprojectNO = $sqlHTFetch[2];
//
////取得HS競賽資訊
//$sqlHS = mysql_query(" SELECT * FROM histock_eventList WHERE projectNO LIKE 'HS%' ORDER BY id DESC ");
//$sqlHSFetch = mysql_fetch_row($sqlHS);
//$HSprojectNO = $sqlHSFetch[2];
...
<div class="main">
	<div class="containerIndex">
		<form class="" method="POST" style="padding-top: 50px;" action="../view/histock_reGetCodeSent.php">
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							...
							<option value="" style="text-align: center;text-align-last: center;">選擇已報名之活動項目</option>
								<?php
//									$str = "SELECT projectNO, projectName FROM histock_eventList WHERE startSignup <= '$getToday' AND endSignup >= '$getToday' ";
									$str = "SELECT projectNO, projectName FROM histock_eventList WHERE startSignup ";
				...
				<div class="row mx-auto text-center mt-3">
					<div class="col-2 mx-auto text-center"></div>
						<div class="col-8">
							<input type="text" class="form-group form-control mx-auto text-center" id="identifyNO" name="identifyNO" placeholder="請輸入身份證字號">
							<input type="text" class="form-group form-control mx-auto text-center" id="email" name="email" placeholder="請輸入E-mail">
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-3">
					<div class="col-2"></div>
						<div class="col-8">
							<small class="form-text text-danger mx-auto text-center">※ 此功能僅能於該活動報名期間，用於更新Email重新接收活動驗證碼。</small>
