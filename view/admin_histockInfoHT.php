...
$InfoHT = mysql_query("SELECT * FROM histock_HTinfo ORDER BY id DESC");//從competCollege中選取全部(*)的資料
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li>金融證券實務/金融證券投資實務輔導員選拔 - 教師資訊</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">金融證券投資實務輔導員選拔 - 教師資訊</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<form align="center" name="export" action="../model/admin_exportHistockHT.php" method="post">
					...
					<div class="panel-body">
						<table id="competForm" class="table table-hover table-striped table-bordered text-center" style="100%">
							...
							<?php
							for ($i=1; $i<=mysql_num_rows($InfoHT); $i++) {
								$row=mysql_fetch_row($InfoHT);
							?>
