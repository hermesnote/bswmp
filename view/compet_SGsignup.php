...
.banner_inner{
	...
	line-height: 1.8;
	color: #000000;
	background-image: url("../img/compet_index.jpg");
...
<div class="main">
	<div class="containerIndex">
		<form class="" method="POST" style="padding-top: 50px;">
			...
			<div class="h3 mx-auto text-center" style="color: #000000.;"><?php echo $SGcompetprojectName; ?></div>
				...
				<div class="row mt-3">
					<div class="col-2"></div>
						<div class="col-8">
							...
							<small id="loginHelp" class="form-text text-muted text-right"><span id="SGcompetNameMsg"><span id="teamNameMsg">※ 最多8個中文字</span></small>
						</div>
					<div class="col-2"></div>
				</div>
			...
			<button type="button" class="form-control btn btn-lg btn-outline-warning" style="text-align: center; width: 50%" onClick="SGgetCode()">索取競賽驗證碼</button>
			<small id="" class="form-text text-muted mx-auto text-center pt-3"><a href="../view/compet_reGetCode.php">沒有收到驗證碼嗎?</a></small>
			<br><span id="SGgetCodeMsg"></span>
			</div>
...
<!--
			<p class="h5 pt-2">獎勵發放：</p>
				<p class="h5 pl-3 pt-2"><strong>全國財富管理競賽｜全國大專財富管理競賽</strong></p>
					<p class="h6 pl-5">所有獎項於頒獎典禮發放</p>
				<p class="h5 pl-3 pt-2"><strong>全國大專校院北、中、南分區理財規劃案例競賽</strong></p>
					<p class="h6 pl-5">公佈得獎名單後一個月內</p>
-->
...
<script src="../controller/compet_SGgetCode.js"></script>
<!-- 輸入框click時, 將小字改回 -->
<script>
