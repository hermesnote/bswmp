...
<!-- Tabs Titles -->
	...
	<!-- Icon -->
			<div class="fadeIn first">
				...
				<div class="h3 text-info">決賽檔案上傳</div>
			</div>
    ...
    <form action="https://script.google.com/macros/s/AKfycbwOi2MA50kPOaOoahpnEm5nPHFuJA2bfxNXQh5ZXASoC_YlFaU5itFh-_nIYUBnw2Tn/exec" id="form" method="post">
		...
		<small class="form-text text-muted mx-auto text-center">※ 一次限上傳一個檔案，可重覆上傳</small>
...
<script>
	function showUploading(){
		...
		$.ajax({
			...
			url:"https://wmpcca.com/bswmp/form/model/compet_Uploading2.php",
			data:{},
