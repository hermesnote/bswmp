...
$projectNO = $HSsqlFETCHcompetData[2]; //競賽代號
$projectBach = substr($HSsqlFETCHcompetData[2], 2); // 競賽梯次
$projectName = $HSsqlFETCHcompetData[3]; //競賽名稱
$start = $HSsqlFETCHcompetData[5]; //開始時間
$end = $HSsqlFETCHcompetData[6]; //結束時間
$amount = $HSsqlFETCHcompetData[18]; //報名限額

//取得場次及名額
$bach1 = substr($HSsqlFETCHcompetData[7], 0, 10);
$bach1weekday = "星期".$weekarray[date("w", strtotime($bach1))];
$bach1Limit = $HSsqlFETCHcompetData[9];
$bach2 = substr($HSsqlFETCHcompetData[10], 0, 10);
$bach2weekday = "星期".$weekarray[date("w", strtotime($bach2))];
$bach2Limit = $HSsqlFETCHcompetData[12];
$bach3 = substr($HSsqlFETCHcompetData[13], 0, 10);
$bach3weekday = "星期".$weekarray[date("w", strtotime($bach3))];
$bach3Limit = $HSsqlFETCHcompetData[15];

//取得各場次已報名
$sqlBach1Count = mysql_query("
	SELECT * FROM histock_HSsignup WHERE bach = 'bach1' AND projectNO = '$projectNO'
");
$bach1Used = mysql_num_rows($sqlBach1Count);

$sqlBach2Count = mysql_query("
	SELECT * FROM histock_HSsignup WHERE bach = 'bach2' AND projectNO = '$projectNO'
");
$bach2Used = mysql_num_rows($sqlBach2Count);

$sqlBach3Count = mysql_query("
	SELECT * FROM histock_HSsignup WHERE bach = 'bach3' AND projectNO = '$projectNO'
");
...
//	echo "alert('目前非開放時間！');";
//	echo "window.location.href = 'https://wmpcca.com/bswmp/form/view/histock_index.php';";
//	echo "</script>";
//}
...
.banner_inner{
	...
	line-height: 1.8;
	color: #000000;
	background-image: url("../img/histockHeader.png");
...
<section class="home_banner_area">
	<div class="banner_inner">
		<div class="main">
			...
			<form class="" id="signupForm" method="POST" style="padding-top: 50px;">
...
<!--  隊伍資料區域  -->			
			<div id="amountArea">
				...
				<div class="h5 mx-auto text-center" style="color: #000000.;"><?php echo $projectName; ?> (<?php echo $projectNO; ?>)</div>
				<div class="text-mute mx-auto text-center" style="color: #000000.;">本次活動每校可報名名額：<? echo $amount;?> 隊</div>
				
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-4">
							<label for="conference">選擇分區</label>
							<select name="conference" class="form-control text-center mx-auto" id="conference" style="text-align:center;text-align-last:center;">
							</select>
						</div>
						<div class="col-4">
							<label for="city">所在城市</label>
							<select name="city" class="form-control" id="city" style="text-align:center;text-align-last:center;">
							</select>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-8">
							...
							<select name="hischool" class="form-control" id="hischool" style="text-align:center;text-align-last:center;">
							</select>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						...
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-warning" style="text-align: center;" onClick="amountCHK()">下一步</button>
						</div>
					<div class="col-2"></div>
				</div>
...
<!--  隊長資料區域  -->
			...
			<div class="h4 mx-auto text-center" style="color: #0B7376;">隊長資料（必要）</div>
				
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="capName">
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="capId">
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="capSN">
							<span class="label2">學號</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="identifyNOMsg">※ 請填寫在校學號</small>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" maxlength="10" style="text-align: center" id="capMobile">
							<span class="label1">行動電話</span>
							<span class="border1"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="mobileMsg">※ 填寫格式：0912345678</span></small>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="capEmail">
							<span class="label4">電子信箱</span>
							<span class="border4"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="emailMsg">※ 強烈建議使用Gmail，其它免費信箱可能無法正常寄送</span></small>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-success" style="text-align: center;" onClick="back2Amount()">上一步</button>
						</div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-warning" style="text-align: center;" onClick="viceAdd()">下一步</button>
						</div>
					<div class="col-2"></div>
				</div>
...
<!--  副手資料區域  -->
			...
			<div class="h4 mx-auto text-center" style="color: #0B7376;">副手資料（必要）</div>
				
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="viceName">
							<span class="label2">姓名</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="nameMsg">※ 外籍在台人士請填寫居留證件中文全名</span></small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="viceId">
							<span class="label2">身份證字號</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="identifyNOMsg">※ 外籍在台人士請填寫居留證號</small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="viceSN">
							<span class="label2">學號</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="identifyNOMsg">※ 請填寫在校學號</small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" maxlength="10" style="text-align: center" id="viceMobile">
							<span class="label1">行動電話</span>
							<span class="border1"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="mobileMsg">※ 填寫格式：0912345678</span></small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="viceEmail">
							<span class="label4">電子信箱</span>
							<span class="border4"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="emailMsg">※ 強烈建議使用Gmail，其它免費信箱可能無法正常寄送</span></small>
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-success" style="text-align: center;" onClick="back2Cap()">上一步</button>
						</div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-warning" style="text-align: center;" onClick="confirmSub()">下一步</button>
						</div>
					<div class="col-2"></div>
				</div>
...
<!--
				<div class="row mt-4">
					<div class="col-2"></div>
						...
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-warning" style="text-align: center;" onClick="memAdd()">下一步</button>
						</div>
					<div class="col-2"></div>
				</div>
-->
...
<!--
			<div id="memArea">
			<div class="h4 mx-auto text-center" style="color: #0B7376;">隊員資料（若無則下一步）</div>
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="memName">
							<span class="label2">姓名</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="nameMsg">※ 外籍在台人士請填寫居留證件中文全名</span></small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="memId">
							<span class="label2">身份證字號</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="identifyNOMsg">※ 外籍在台人士請填寫居留證號</small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="memSN">
							<span class="label2">學號</span>
							<span class="border2"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="identifyNOMsg">※ 請填寫在校學號</small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" maxlength="10" style="text-align: center" id="memMobile">
							<span class="label1">行動電話</span>
							<span class="border1"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="mobileMsg">※ 填寫格式：0912345678</span></small>
				...
				<div class="row mt-0">
					<div class="col-2"></div>
						<div class="col-8">
							<label for="inp" class="inp">
							<input type="text" placeholder="&nbsp;" style="text-align: center" id="memEmail">
							<span class="label4">電子信箱</span>
							<span class="border4"></span>
							</label>
							<small id="loginHelp" class="form-text text-muted text-right"><span id="emailMsg">※ 強烈建議使用Gmail，其它免費信箱可能無法正常寄送</span></small>
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-success" style="text-align: center;" onClick="back2Vice()">上一步</button>
						</div>
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-warning" style="text-align: center;" onClick="confirmSub()">下一步</button>
						</div>
			...
			<div class="row mt-5">
				...
				<div class="row mt-4">
					<div class="col-2"></div>
						...
						<div class="col-4 mx-auto text-center">
							<button type="button" class="mb-5 form-control btn btn-lg btn-danger" style="text-align: center;" onClick="clearAll()">清除重填</button>
						</div>
					<div class="col-2"></div>
				</div>
			
			<div class="mt-3 mx-auto text-center" style="padding-bottom: 50px;">
<!--				<button type="button" class="mt-2 form-control btn btn-lg btn-outline-danger" style="text-align: center; width: 50%" onClick="back2Amount()">重新填寫</button>-->
				<button type="button" class="mt-2 form-control btn btn-lg btn-outline-warning" id="HSgetCodeButton" style="text-align: center; width: 50%" onClick="HSgetCode()">索取競賽驗證碼</button>
				<small id="" class="form-text text-muted mx-auto text-center pt-3"><a href="../view/histock_reGetCode.php">沒有收到驗證碼嗎?</a></small>
				<br><span id="HSgetCodeMsg"></span>
			</div>
...
<section class="price_area p_120">
	<div class="container">
		<input type="text" placeholder="<?php echo $HScompetprojectNO ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $HScompetprojectName ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $HScompetStartDate ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $HScompetEndDate ; ?>" disabled>
	</div>
</section>
-->
<!-- TEST End -->
...
<script src="../controller/histock_HSgetCode.js"></script>
<script src="../controller/histock_HSamountCHK.js"></script>
<script src="../controller/histock_HScapCHK.js"></script>
<script src="../controller/histock_HSviceCHK.js"></script>
<script src="../controller/histock_HSmemCHK.js"></script>
<!-- 輸入框click時, 將小字改回 -->
<script>
...
<script>
	$(document).ready(function(){
		$("#amountArea").fadeIn("slow"); // fadeIn 學校區塊
		$("#capArea").fadeOut("fast"); // fadeOut 隊長區塊
		$("#viceArea").fadeOut("fast"); // fadeOut 副手區塊
		$("#memArea").fadeOut("fast"); // fadeOut 隊員區塊
		$("#confirmSub").fadeOut("fast"); // fadeOut 提交區塊
	});
	function back2Cap(){
	...
	function back2Vice(){
		$("#amountArea").fadeOut("fast"); // fadeOut 學校區域
		$("#capArea").fadeOut("fast"); // fadeIn 隊長區域
		$("#viceArea").fadeIn("slow"); // fadeOut 副手區域
		$("#memArea").fadeOut("fast"); // fadeOut 隊員區域
		$("#confirmSub").fadeOut("fast"); // fadeOut 提交區域
	}
	function back2Mem(){
		...
		$("#capArea").fadeOut("fast"); // fadeIn 隊長區域
		$("#viceArea").fadeOut("fast"); // fadeOut 副手區域
		$("#memArea").fadeIn("slow"); // fadeOut 隊員區域
		$("#confirmSub").fadeOut("fast"); // fadeOut 提交區域
	}
	function back2Amount(){
		$("#amountArea").fadeIn("slow"); // fadeIn 學校區塊
		$("#capArea").fadeOut("fast"); // fadeOut 隊長區塊
		$("#viceArea").fadeOut("fast"); // fadeOut 副手區塊
		$("#memArea").fadeOut("fast"); // fadeOut 隊員區塊
