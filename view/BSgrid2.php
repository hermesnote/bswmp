...
//產生到期日
//$RP001endDate = date('Y-m-d', strtotime("$getToday+12months 7days"));
//$RP002endDate = date('Y-m-d', strtotime("$getToday+25months 7days"));
//$RP003endDate = date('Y-m-d', strtotime("$getToday+39months 7days"));
	...
	<div class="container">
		<div class="row">
			<div class="col mx-auto text-center">
				...
				<p class="h2">KEYs財富管理系統<span class="h6">(續期)</span></p>
			</div>
		</div>
	</div>
</section>
...
-->
	...
	<div class="row">
		<div class="col-md-4 pt-3">
			...
			<div class="card-body">
				<input type="radio" class="radioStyle" id="RP001" name="select" value="RP001" checked>
				<label class="radioStyle-label" for="RP001">
				<h2 class="pt-2">專業版續期</h2>
				<p class="h4">12個月</p>
				<p class="h1">$6,000</p>
				</label>
			</div>
        ...
        <div class="col-md-4 pt-3">
			...
			<div class="card-body">
				<input type="radio" class="radioStyle" id="RP002" name="select" value="RP002">
				<label class="radioStyle-label" for="RP002">
				<h2 class="pt-2">專業版續期</h2>
				<p class="h4">25個月</p>
				<p class="h1">$10,800</p>
				</label>
        ...
        <div class="col-md-4 pt-3">
			...
			<div class="card-body">
				<input type="radio" class="radioStyle" id="RP003" name="select" value="RP003">
				<label class="radioStyle-label" for="RP003">
				<h2 class="pt-2">專業版續期</h2>
				<p class="h4">39個月</p>
				<p class="h1">$14,800</p>
				</label>
    ...
    <div class="col-md-9 not-right-table-content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 pt-2">
			...
			<div class="card-body">
			<h5 class="card-title font-weight-bolder"><i class="fas fa-user h5"></i><span class="pl-2">KEYs帳號資訊 </span></h5>
				
			<div class="row">
				<div class="col-1"></div>
				<div class="col-10">
					<div class="input-group mb-3 pt-2">
					<input type="text" class="form-control" placeholder="請輸入欲續期的KEYs帳號" aria-label="Recipient's username" aria-describedby="basic-addon2" id="UserName">
...
<!--				<form name="submitOrder" id="submitOrder" action="" method="post">-->
				...
				<div class="card-title h2 text-success font-weight-bolder"><span class="pl-4" id="showPrice">$6,000</span></div>
				
				<hr width="90%">
				
				<div class="pb-2"><i class="fas fa-unlock-alt h5"></i></i><span class="pl-3 font-weight-bolder">授權版本:</sapn></div>
				<div class="card-text h5 text-success font-weight-bolder"><span class="pl-4">KEYs《專業版》續期</span></div>
				...
				<div class="card-text h5 text-success font-weight-bolder"><span class="pl-4">至 <span id="endDate"></span></span> 止</div>
...
$(".radioStyle").on("click", function () {
    ...
    switch (checkVal) {
        case "RP001":
			...
			$("#months").text("12");
			$("#endDate").text("<? echo $RP001endDate ?>");
            break;
        case "RP002":
            $("#showPrice").text("$10,800");
			$("#months").text("25");
			$("#endDate").text("<? echo $RP002endDate ?>");
            break;
        case "RP003":
            $("#showPrice").text("$14,800");
			$("#months").text("39");
			$("#endDate").text("<? echo $RP003endDate ?>");
            break;
    }
});
</script>
