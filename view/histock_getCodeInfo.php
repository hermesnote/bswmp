...
<title>WMPCCA - 歡迎參加全國金融證券投資實務競賽</title>
		...
		<form class="" method="POST" style="padding-top: 50px;">
				...
				<div class="row mt-0 mx-auto text-center">
					<div class="col-2 mx-auto text-center"></div>
						<div class="col-8">
							<h3 style="color: #0B7376">已將參賽驗證碼寄至您的E-mail</h3>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-0 mx-auto text-center">
					<div class="col-2 mx-auto text-center"></div>
						<div class="col-8">
							<h4 style="color: #FAB216"><a href="https://wmpcca.com/bswmp/form/view/histock_index.php">點此登入活動專區</a></h4>
						</div>
					<div class="col-2"></div>
				</div>
				...
				<div class="row mt-5 mx-auto text-center">
					<div class="col-2 mx-auto text-center"></div>
						<div class="col-8">
							<small id="" class="form-text text-muted mx-auto text-center"><a href="../view/histock_reGetCode.php">沒有收到驗證碼嗎?</a></small>
							<small id="" class="form-text text-muted mx-auto text-center">先別急著重新補發，先到<u>「<a href="https://support.google.com/a/answer/9275489?hl=zh-Hant&ref_topic=2683828" target="_blank">垃圾郵件</a>」</u>裡挖看看!?</small>
						</div>
					<div class="col-2"></div>
				</div>
