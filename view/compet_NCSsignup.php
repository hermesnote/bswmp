...
<div class="main">
	<div class="containerIndex">
		<form class="" method="POST" style="padding-top: 50px;">
			...
			<div class="h5 mx-auto text-center" style="color: #000000.;"><?php echo $NCScompetprojectName; ?></div>
				...
				<div class="row mt-3">
					<div class="col-2"></div>
						<div class="col-8">
							<label class="customcheck">申請配發競賽輔導顧問（勾選：由協會配發合格之競賽輔導顧問；不勾選：由各隊自行決定,但相關輔導人士不授予協會輔導證明。）
			...
			<button type="button" class="form-control btn btn-lg btn-outline-warning" style="text-align: center; width: 50%" onClick="NCSgetCode()">索取競賽驗證碼</button>
			<small id="" class="form-text text-muted mx-auto text-center pt-3"><a href="../view/compet_reGetCode.php">沒有收到驗證碼嗎?</a></small>
			<br><span id="NCSgetCodeMsg"></span>
			</div>
...
<section class="price_area p_120">
	<div class="container">
		<input type="text" placeholder="<?php echo $NCScompetprojectNO ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $NCScompetprojectName ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $NCScompetStartDate ; ?>" disabled><br>
		<input type="text" placeholder="<?php echo $NCScompetEndDate ; ?>" disabled>
	</div>
</section>
-->
<!-- TEST End -->
...
<script src="https://code.jquery.com/ui/1.12.0/jquery-ui.min.js" integrity="sha256-eGE6blurk5sHj+rmkfNCSYeKyZx3M4bG+ZlFyA7Kns7E=" crossorigin="anonymous"></script>
...
<script src="../controller/compet_NCSgetCode.js"></script>
<!-- 輸入框click時, 將小字改回 -->
<script>
