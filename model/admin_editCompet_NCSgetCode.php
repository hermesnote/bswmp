...
// 取得競賽年份
$competYear = substr($projectNO,3,2);
...
if ( $schoolDistrict == "北區" ){
	$teamNOHeader = "CN";
}else if ( $schoolDistrict == "中區" ){
	$teamNOHeader = "CC";
}else if ( $schoolDistrict == "南區" ){
	$teamNOHeader = "CS";
}

$teamNO = $teamNOHeader.$competYear.substr(date("d"),0,2).substr(date("s"),0,2).str_pad(mt_rand(0000, 9999), 4, "0", STR_PAD_LEFT);
