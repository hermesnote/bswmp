...
if ($signupData != 0 || $sqlcaptainData != 0 || $sqlmember2Data != 0){
	...
	$sqlInsert = "
		...
		VALUES ('$getToday', '$projectNO', '$teamNO', '$name', '$identifyNO', '$sex', '$birthday', '$phone', '$email', '$city', '$district', '$addr', '$combineAddr', '$school', '$college', '$depart', '$degree', '$grade', '$remarks' )
	";
	...
	$sqlUpdate = "
		UPDATE $memberDB
		SET name='$name', identifyNO='$identifyNO', sex='$sex', birthday='$birthday', phone='$phone', email='$email', city='$city', district='$district', addr='$addr', combineAddr='$combineAddr', college='$college', depart='$depart', degree='$degree', grade='$grade'
		WHERE teamNO = '$teamNO' AND remarks = '副手'
	";
...
//寫入Log
	...
	$log =  "\r\n$todayDate $staffNO 編修了 $teamNO 的副手資料";
