...
<!-- 資料傳送表單 -->
<form name="ccPostForm" method="post" id="ccPostForm" action="../ecPay/Hoyo_Ecpay.php" target="_blank">
<!-- 報名資訊 -->
...
<div class="mx-auto text-center my-5">
	<button type="button" onclick="history.back()" class="btn btn-outline-danger mr-4" id="dropSignupButton"><span class="fa fa-times"></span>放棄，回上一頁</button>
	<button type="button" onclick="printPage()" class="btn btn-outline-info mx-4"><span class="fa fa-print"></span>列印本頁</button>
	<button type="button" onclick="confirmPay()" class="btn btn-outline-warning ml-4"><span class="fa fa-share-square-o"></span>下一步，選擇繳費方式</button>
</div>
</form>
</div>
</div>