...
$surveyNumber = $_POST["selectSurvey"];
	if($surveyNumber == ''){
		echo json_encode($selectSurveyEPT);
		exit();
	}
...
//更新competRefer資料庫
	$sqlINSERTcompetProject = "
		INSERT INTO competList ( projectNO, projectName, amount, competStartDate, competEndDate, payStartDate, payEndDate, report1Date, report2Date, downloadLink, surveyNumber ) 
		VALUES( '$projectNO', '$projectName', '$amount', '$competStartDate', '$competEndDate', '$payStartDate', '$payEndDate', '$report1Date', '$report2Date', '$downloadLink', '$surveyNumber' )
		";
