...
<!--
					<li>
						<a class="" href="">
							<span class="glyphicon glyphicon-list-alt"></span> 補助申請
						</a>
					</li>
-->
					<li>
			...
			<li class="parent authority2">
				...
				<ul class="children collapse show" id="sub-item-2">
					...
					<li>
						<a class="" href="#">
							<span class="glyphicon glyphicon-list-alt"></span> 成績評審
						</a>
					</li>
					<li>
						<a class="" href="#">
					...
					<li>
						<a class="" href="admin_competHiStock.php">
							<span class="glyphicon glyphicon-list-alt"></span> 報名隊伍
						</a>
					</li>
					<li>
						<a class="" href="admin_competHiStudents.php">
