...
$mail->AddAddress($getMember1Email);
 ...
 <table border='3' bordercolor='#067277' cellpadding='0' cellspacing='0' width='80%' align='center'>
  <tr>
   <td align='center'>
	  ...
	  <br>
	  <br>
	  <a style='color:silver;font-family:微軟正黑體;font-size:16px;font-weight: 800;'>※以上報名資料如有問題請利用下方表單聯絡協會</a><br>
	  <a style='color:silver;font-family:微軟正黑體;font-size:16px;font-weight: 800;'>(收據請連結郵件下方「競賽活動專區」，輸入「隊伍編號」取得)</a><br>
		<hr color='white'>
   </td>
  </tr>
 </table>
